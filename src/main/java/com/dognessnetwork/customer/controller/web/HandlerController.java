...
public class HandlerController {
    ...
    public String index1(String username, HttpServletRequest request, HttpServletResponse response) {
        ...
        // String res =
        // HttpUtil.post("http://192.168.0.197:8088/users/test","");
        /*
         * CloseableHttpClient httpClient = HttpClientBuilder.create().build();
         * // 2. 创建HttpPost对象 HttpPost post = new HttpPost(
         * "http://192.168.0.197:8088/users/query_by_username;");
         * post.setHeader("Cookie","JSESSIONID=" +
         * redisService.getStr("sessionId")); // 3. 设置POST请求传递参数
         * List<NameValuePair> params = new ArrayList<NameValuePair>();
         * params.add(new BasicNameValuePair("username", "lisisi"));
         * //params.add(new BasicNameValuePair("password", "12356")); try {
         * UrlEncodedFormEntity entity = new UrlEncodedFormEntity(params);
         * post.setEntity(entity); } catch (UnsupportedEncodingException e) {
         * e.printStackTrace(); } // 4. 执行请求并处理响应 try { CloseableHttpResponse
         * response1 = httpClient.execute(post); HttpEntity entity =
         * response1.getEntity(); if (entity != null){
         * System.out.println("响应内容：");
         * System.out.println(EntityUtils.toString(entity)); }
         * response1.close(); } catch (ClientProtocolException e) {
         * e.printStackTrace(); } catch (IOException e) { e.printStackTrace(); }
         * finally { // 释放资源 try { httpClient.close(); } catch (IOException e) {
         * e.printStackTrace(); } }
         */
        Console.log("getId");
        // Console.log(res);
    ...
    public String message(String username, String token, HttpServletRequest request, String platForm, String area) {
